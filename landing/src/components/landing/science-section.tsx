...
export function ScienceSection() {
  ...
  return (
    <section className="grid grid-cols-2 min-h-[440px] max-sm:grid-cols-1" id="science">
        ...
        <div className="relative z-1">
          ...
          <Reveal delay={0.16}>
            <ul className="list-none mb-8 p-0">
              {points.map((pt, i) => (
                <li key={i} className="science-point text-[0.82rem] text-brand-light/50 py-2 pl-6 relative leading-normal">
                  {pt}
                </li>
              ))}
            </ul>
          ...
          <Reveal delay={0.24}>
            <Button variant="brand-outline" size="brand" asChild className="max-sm:w-full max-sm:text-center">
